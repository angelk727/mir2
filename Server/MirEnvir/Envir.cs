...
namespace Server.MirEnvir
{
    ...
    public class Envir
    {
        ...
        private void FillMagicInfoList()
        {
            ...
            if (!MagicExists(Spell.LionRoarRare)) MagicInfoList.Add(new MagicInfo { Name = "狮子吼-秘籍", Spell = Spell.LionRoarRare, Icon = 112, Level1 = 36, Level2 = 39, Level3 = 41, Need1 = 8900, Need2 = 15000, Need3 = 21600, BaseCost = 14, LevelCost = 4, Range = 0 });
            if (!MagicExists(Spell.DimensionalSword)) MagicInfoList.Add(new MagicInfo { Name = "时空剑", Spell = Spell.DimensionalSword, Icon = 117, Level1 = 60, Level2 = 63, Level3 = 65, Need1 = 3800, Need2 = 6300, Need3 = 9300, BaseCost = 32, LevelCost = 4, MPowerBase = 1, PowerBase = 3, DelayBase = 14000, DelayReduction = 4000, Range = 2 , MultiplierBase = 1f, MultiplierBonus = 0.25f});
            if (!MagicExists(Spell.DimensionalSwordRare)) MagicInfoList.Add(new MagicInfo { Name = "时空剑-秘籍", Spell = Spell.DimensionalSwordRare, Icon = 122, Level1 = 60, Level2 = 63, Level3 = 65, Need1 = 8800, Need2 = 13000, Need3 = 21600, BaseCost = 32, LevelCost = 4, MPowerBase = 1, PowerBase = 3, DelayBase = 14000, DelayReduction = 4000, Range = 2 , MultiplierBase = 1f, MultiplierBonus = 0.25f});
        ...
        private string CanStartEnvir()
        {
            ...
            if (Settings.EnforceDBChecks)
            {
                ...
                if (GetMonsterInfo(Settings.Mon570NMirrorImageMob, true) == null) return "缺少必要怪物无法启动服务器 " + Settings.Mon570NMirrorImageMob;
                if (GetMonsterInfo(Settings.Mon573NMob, true) == null) return "缺少必要怪物无法启动服务器 " + Settings.Mon573NMob;
