...
namespace Server.MirEnvir
{
    ...
    public class Envir
    {
        ...
        private void FillMagicInfoList()
        {
            ...
            if (!MagicExists(Spell.SoulflameSiphon)) MagicInfoList.Add(new MagicInfo { Name = "吸魔炎风", Spell = Spell.SoulflameSiphon, Icon = 119, Level1 = 90, Level2 = 92, Level3 = 94, Need1 = 6300, Need2 = 9300, Need3 = 15200, BaseCost = 30, LevelCost = 5, MPowerBase = 3, PowerBase = 3, Range = 9 });
            if (!MagicExists(Spell.SoulflameSiphonRare)) MagicInfoList.Add(new MagicInfo { Name = "吸魔炎风-秘籍", Spell = Spell.SoulflameSiphonRare, Icon = 124, Level1 = 100, Level2 = 105, Level3 = 110, Need1 = 8800, Need2 = 13000, Need3 = 21600, BaseCost = 30, LevelCost = 5, MPowerBase = 3, PowerBase = 3, Range = 9 });
            ...
            if (!MagicExists(Spell.OneWithNature)) MagicInfoList.Add(new MagicInfo { Name = "血龙闪-秘籍", Spell = Spell.OneWithNature, Icon = 106, Level1 = 62, Level2 = 64, Level3 = 66, Need1 = 5700, Need2 = 11000, Need3 = 15900, BaseCost = 40, LevelCost = 15, MPowerBase = 75, MPowerBonus = 35, PowerBase = 30, PowerBonus = 20, Range = 9 });
