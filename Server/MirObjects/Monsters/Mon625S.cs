                    ...
                    case 0:
                        {
                            ...
                            if (Envir.Random.Next(100) < 80) WideLineAttack(damage, 1, 1200, DefenceType.ACAgility, false, 3);
                    ...
                    case 1:
                        {
                            ...
                            if (Envir.Random.Next(100) < 50) WideLineAttack(damage, 1, 1200, DefenceType.ACAgility, false, 3);
                    ...
                    case 1:
                        {
                            ...
                            WideLineAttack(damage, 5, 1200, DefenceType.ACAgility, false, 5);
                            DelayedAction action = new(DelayedType.Damage, Envir.Time + 1200, Target, damage, DefenceType.ACAgility, false);
                            ActionList.Add(action);
                        }
                        break;
