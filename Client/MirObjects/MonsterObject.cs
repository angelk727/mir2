                    ...
                    case Monster.Mon620B:
                        {
                            ...
                            var effects = MapControl.Effects.Where(x => x.Library == Libraries.Monsters[(ushort)Monster.Mon620B]);

                            foreach (var effect in effects)
                                effect.Repeat = false;

                                MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1670, 6, 600, new Point(96, 92)) { Repeat = true });
                            {
                                if (info.ExtraByte > 1)
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1550, 6, 600, new Point(96, 92)) { Repeat = true });
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1560, 6, 600, new Point(96, 92)) { Repeat = true });
                                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1570, 6, 600, new Point(96, 92)) { Repeat = true });
                                if (info.ExtraByte > 2)
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1590, 6, 600, new Point(96, 92)) { Repeat = true });
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1600, 6, 600, new Point(96, 92)) { Repeat = true });
                                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1610, 6, 600, new Point(96, 92)) { Repeat = true });
                                if (info.ExtraByte > 3)
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1630, 6, 600, new Point(96, 92)) { Repeat = true });
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1640, 6, 600, new Point(96, 92)) { Repeat = true });
                                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1650, 6, 600, new Point(96, 92)) { Repeat = true });
                                if (info.ExtraByte > 4)
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1510, 6, 600, new Point(96, 92)) { Repeat = true });
                                    //MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1520, 6, 600, new Point(96, 92)) { Repeat = true });
                                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon620B], 1530, 6, 600, new Point(96, 92)) { Repeat = true });
                            }
                        }
                        break;
                }
                    ...
                    case MirAction.弓箭跳跃:
                        ...
                        switch (BaseImage)
                        {
                            ...
                            case Monster.Armadillo:
                                MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)BaseImage], 600, 12, 600, CurrentLocation, CMain.Time + 900));
                                break;
                        }
                        break;
                    ...
                    case MirAction.近距攻击1:
                        ...
                        switch (BaseImage)
                        {
                            case Monster.FlamingWooma:
                                ...
                                break;
                            case Monster.Mon63B:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon63B], 244 + (int)Direction * 8, 8, 8 * FrameInterval, this));
                                break;
                            ...
                            case Monster.Mon601N:
                                ...
                                break;
                            case Monster.Mon621N:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon621N], 490 + (int)Direction * 10, 10, Frame.Count * Frame.Interval, this) { Blend = true });
                                break;
                            case Monster.Mon622N:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon622N], 593 + (int)Direction * 20, 20, Frame.Count * Frame.Interval, this) { Blend = true });
                                break;
                        }
                        break;
                    case MirAction.近距攻击2:
                        ...
                        switch (BaseImage)
                        {
                            ...
                            case Monster.Mon579B:
                                ...
                                break;
                            case Monster.Mon637B:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon637B], 1228, 4, 4 * 200, this) { DrawBehind = true, Blend = false });
                                break;
                        }
                    ...
                    case MirAction.近距攻击3:
                        ...
                        switch (BaseImage)
                        {
                            ...
                            case Monster.Mon571B:
                                ...
                                break;
                            case Monster.Mon615B:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon615B], 1095, 10, 800, this) { Blend = true, DrawBehind = true , Start = CMain.Time + 1200 });
                                break;
                        }
                        break;
                    ...
                    case MirAction.远程攻击1:
                        ...
                        switch (BaseImage)
                        {
                            ...
                            case Monster.Mon354B:
                                ...
                                if (locations != null)
                                {
                                    for (int i = 0; i < locations.Length; i++)
                                    {
                                        ...
                                        long start = CMain.Time + CMain.Random.Next(600);

                                        Effect ef1 = new Effect(Libraries.Monsters[(ushort)Monster.Mon354B], 552, 20, 1200, source, start) { Blend = false };
                                        Effect ef2 = new Effect(Libraries.Monsters[(ushort)Monster.Mon354B], 572, 20, 1200, source, start) { Blend = true };
                            ...
                            case Monster.Mon603B:
                                ...
                                break;
                            case Monster.Mon621N:
                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon621N], 620, 12, 12 * 120, this) { Blend = true });
                                break;
                        }
                        break;
                    case MirAction.远程攻击2:
                                ...
                                case 1:
                                    {
                                        ...
                                        {
                                            case Monster.CreeperPlant: //383
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.CreeperPlant], 250, 6, 6 * 200, this));
                                                break;
                                            case Monster.Mon575S:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon575S], 403, 7, 7 * 200, this) { Blend = true });
                                                break;
                                            case Monster.Mon627P:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon627P], 376, 12, 12 * 200, this) { Blend = false});
                                                break;
                                        }
                                        break;
                                    }
                                ...
                                case 4: // 击中目标动画
                                    {
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.FlamingMutant: //257
                                                ...
                                                break;
                                            case Monster.Mon432P:
                                                Effect waterDragonEffect = new Effect(Libraries.Monsters[(ushort)Monster.Mon432P], 905, 9, 900, front, CMain.Time + 300);
                                            ...
                                            case Monster.Mon573B:
                                                ...
                                                break;
                                            case Monster.Mon575S:
                                                MapObject Mon575Sob1 = MapControl.GetObject(TargetID);
                                                if (Mon575Sob1 != null)
                                                    Mon575Sob1.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon575S], 394, 9, 600, Mon575Sob1));
                                                break;
                                            case Monster.Mon590N:
                                            ...
                                            case Monster.Mon624B:
                                                ...
                                                break;
                                            case Monster.Mon625S:
                                                MapObject Mon625Sob1 = MapControl.GetObject(TargetID);
                                                if (Mon625Sob1 == null)
                                                    break;
                                                if (CMain.Random.Next(100) < 70)
                                                {
                                                    Mon625Sob1.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon625S], 529, 6, 600, Mon625Sob1));
                                                }
                                                break;
                                            case Monster.Mon627P:
                                                MapObject Mon627Pob1 = MapControl.GetObject(TargetID);
                                                if (Mon627Pob1 == null)
                                                    break;
                                                if (CMain.Random.Next(100) < 80)
                                                {
                                                    Mon627Pob1.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon627P], 459, 7, 600, Mon627Pob1));
                                                }
                                                break;
                                             case Monster.Mon637B:
                                                MapObject Mon637Bob1 = MapControl.GetObject(TargetID);
                                                if (Mon637Bob1 != null)
                                                    Mon637Bob1.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon637B], 1139, 8, 600, Mon637Bob1));
                                                break;
                                             case Monster.Mon639N:
                                                MapObject Mon639Nob1 = MapControl.GetObject(TargetID);
                                                if (Mon639Nob1 != null)
                                                    Mon639Nob1.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon639N], 280, 6, 600, Mon639Nob1));
                                                break;
                                        }
                                    }
                                    break;
                                ...
                                case 4:
                                    {
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.Mon624B:
                                                ...
                                                break;
                                            case Monster.Mon637B:
                                                MapObject Mon637Bob2 = MapControl.GetObject(TargetID);
                                                if (Mon637Bob2 != null)
                                                    Mon637Bob2.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon637B], 1232, 9, 600, Mon637Bob2));
                                                break;
                                        }
                                    }
                                    break;
                                case 5:
                                    {
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.GeneralMeowMeow: //341
                                                ...
                                                break;
                                            case Monster.Mon354B:
                                                Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon354B], 544, 8, 8 * Frame.Interval, this) { Blend = true, DrawBehind = true });
                                                break;
                                            case Monster.FrozenMiner: //442
                                                Point source = Functions.PointMove(CurrentLocation, Direction, 1);
                                    ...
                                    switch (BaseImage)
                                    {
                                        case Monster.火娃:
                                            if (TrackableEffect.GetOwnerEffectID(this.ObjectID, "CreatureFlame") < 0)
                                                Effects.Add(new TrackableEffect(new Effect(Libraries.Pets[((ushort)BaseImage) - 10000], 264, 4, 800, this), "CreatureFlame"));
                                            break;
                                        case Monster.蛇宝宝:
                                                if (FrameIndex == 1)
                                                {
                                                    if (TrackableEffect.GetOwnerEffectID(this.ObjectID, "SnakeMusic") < 0)
                                                        Effects.Add(new TrackableEffect(new Effect(Libraries.Pets[((ushort)BaseImage) - 10000], 298, 8, 1500, this), "SnakeMusic"));
                                                }
                                                break;
                                    ...
                                    switch (BaseImage)
                                    {
                                        case Monster.火娃:
                                            if (TrackableEffect.GetOwnerEffectID(this.ObjectID, "CreatureSmoke") < 0)
                                                Effects.Add(new TrackableEffect(new Effect(Libraries.Pets[((ushort)BaseImage) - 10000], 240, 3, 1000, this), "CreatureSmoke"));
                                            break;
                                        case Monster.Kirin: //438
                                ...
                                case 5:
                                    switch (BaseImage)
                                    {
                                        ...
                                        case Monster.ShardMaiden: //484
                                            ...
                                            break;
                                         case Monster.Mon614B:
                                                Point Mon614B3 = Functions.PointMove(CurrentLocation, Direction, 2);
                                                MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon614B], 1082, 12, 300, Mon614B3, CMain.Time) { Blend = true });
                                                break;
                                    }
                                    break;
                                case 6:
                                        ...
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.Mon601N:
                                             ...
                                             case Monster.Mon602N:
                                                ...
                                                break;
                                             case Monster.Mon612N:
                                                missile = CreateProjectile(424, Libraries.Monsters[(ushort)Monster.Mon612N], true, 1, 30, 0, direction16: true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon612N], 440, 18, 600, missile.Target) { Blend = true });
                                                    };
                                                }
                                                break;
                                             case Monster.Mon614B:
                                                missile = CreateProjectile(1094, Libraries.Monsters[(ushort)Monster.Mon614B], true, 6, 300, 0, direction16: false);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon614B], 1147, 8, 600, missile.Target) { Blend = true });
                                                    };
                                                }
                                                break;
                                        }
                                ...
                                case 4:
                                    {
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.KingHydrax: //398
                                                ...
                                                break;
                                            case Monster.Mon432P:
                                                missile = CreateProjectile(800, Libraries.Monsters[(ushort)Monster.Mon432P], true, 6, 60, 0, direction16: true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon432P], 896, 9, 900, missile.Target) { Blend = true, DrawBehind = true });
                                                    };
                                                }
                                                break;
                                            ...
                                            case Monster.Mon624B:
                                             ...
                                             case Monster.Mon627P:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon627P], 546, 10, 1200, ob, CMain.Time + 600, false) { Blend = true });
                                                }
                                                break;
                                             case Monster.Mon635S:
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon635S], 655, 33, 900, ob, CMain.Time + 600));
                                                }
                                                break;
                                             case Monster.Mon637B:
                                                missile = CreateProjectile(1305, Libraries.Monsters[(ushort)Monster.Mon637B], true, 5, 50, -5);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon637B], 1318, 8, 600, missile.Target) { DrawBehind = true, Blend = false });
                                                    };
                                                }
                                                break;
                                             case Monster.Mon649B:
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon649B], 497, 22, 1000, ob) { DrawBehind = true });
                                                }
                                                break;
                                        }
                                        break;
                                ...
                                case 7:
                                    {
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.Mon621N:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon621N], 640, 20, 600, ob) { Blend = true, DrawBehind = true });
                                                }
                                                break;
                                        }
                                        break;
                                ...
                                case 4:
                                    {
                                        switch (BaseImage)
                                        {
                                            ...
                                            case Monster.Mon354B:
                                                {
                                                    List<uint> targetIDs = null;

                                                    if (CurrentActionParams != null && CurrentActionParams.Count > 3)
                                                        targetIDs = CurrentActionParams[3] as List<uint>;

                                                    if (targetIDs != null && targetIDs.Count > 0)
                                                    {
                                                        for (int i = 0; i < targetIDs.Count; i++)
                                                        {
                                                            MapObject target = MapControl.GetObject(targetIDs[i]);

                                                            if (target == null)
                                                                continue;

                                                            if (target.CurrentAction == MirAction.死后尸体)
                                                                continue;

                                                            Missile targetMissile = CreateProjectile(592, Libraries.Monsters[(ushort)Monster.Mon354B], true, 9, 30, 0, direction16: true);

                                                            if (targetMissile == null)
                                                                continue;

                                                            targetMissile.Target = target;

                                                            targetMissile.Complete += (o, e) =>
                                                            {
                                                                if (targetMissile.Target == null)
                                                                    return;

                                                                if (targetMissile.Target.CurrentAction == MirAction.死后尸体)
                                                                    return;

                                                                targetMissile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon354B], 736, 9, 500, targetMissile.Target) { Blend = true });
                                                            };
                                                        }
                                                    }
                                                    else
                                                    {
                                                        missile = CreateProjectile(592, Libraries.Monsters[(ushort)Monster.Mon354B], true, 9, 30, 0, direction16: true);
                                                        ...
                                                        missile.Complete += (o, e) =>
                                                        {
                                                            if (missile.Target.CurrentAction == MirAction.死后尸体)
                                                                return;

                                                            missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon354B], 736, 9, 500, missile.Target) { Blend = true });
                                                        };
                                                    }
                                            ...
                                            case Monster.Mon570B:
                                                ...
                                                break;
                                            case Monster.Mon612N:
                                                missile = CreateProjectile(490, Libraries.Monsters[(ushort)Monster.Mon612N], true, 6, 100, 0, direction16: true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon612N], 458, 18, 600, missile.Target) { Blend = true });
                                                    };
                                                }
                                                break;
                                             case Monster.Mon614B:
                                                missile = CreateProjectile(1155, Libraries.Monsters[(ushort)Monster.Mon614B], true, 6, 30, 0, direction16: true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon614B], 1251, 6, 600, missile.Target) { Blend = true });
                                                    };
                                                }
                                                break;
                                            case Monster.Mon615B:
                                                missile = CreateProjectile(1145, Libraries.Monsters[(ushort)Monster.Mon615B], true, 8, 50, 0, direction16: false);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon615B], 1225, 10, 300, missile.Target) { Blend = true, DrawBehind = true });
                                                    };
                                                }
                                                break;
                                            case Monster.Mon635S:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon635S], 768, 8, 900, ob, CMain.Time + 600));
                                                }
                                                break;
                                            case Monster.Mon637B:
                                                ob = MapControl.GetObject(TargetID);
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon637B], 1419, 6, 900, ob, CMain.Time + 600));
                                                }
                                                break;
                                            case Monster.Mon649B:
                                                missile = CreateProjectile(519, Libraries.Monsters[(ushort)Monster.Mon649B], true, 9, 30, 0, direction16: true);
                                                ...
                                                if (missile.Target != null)
                                                {
                                                    ...
                                                    {
                                                        if (missile.Target.CurrentAction == MirAction.死后尸体) return;
                                                        missile.Target.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon649B], 727, 8, 500, missile.Target) { Blend = true });
                                                    };
                                                }
                                                break;
                                        }
                                ...
                                case 4:
                                    {
                                        switch (BaseImage)
                                        {
                                            case Monster.Mon354B:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon354B], 745, 17, 1000, ob) { Blend = true });
                                                }
                                                break;
                                            case Monster.HoodedSummoner: //481
                                            ...
                                            case Monster.Mon649B:
                                                ...
                                                if (ob != null)
                                                {
                                                    ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon649B], 735, 24, 1000, ob) { DrawBehind = true });
                                                }
                                                break;
                                        }
                                    }
                                ...
                                case 4:
                                    ...
                                    switch (BaseImage)
                                    {
                                        ...
                                        case Monster.Mon593N:
                                            ...
                                            break;
                                        case Monster.Mon627P:
                                            Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Mon627P], 388, 7, 7 * Frame.Interval, this, CMain.Time + 100) { Blend = true });
                                            break;
                                    }
                                    break;
                                case 5:
        ...
        public override void DrawEffects(bool effectsEnabled)
        {
            ...
            switch (BaseImage)
            {
                ...
                case Monster.Mon432P:
                    ...
                    {
                        case MirAction.石化苏醒:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(400 + FrameIndex + (int)Direction * 8, DrawLocation, Color.White, true);
                            break;
                        case MirAction.站立动作:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(464 + FrameIndex + (int)Direction * 6, DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(512 + FrameIndex + (int)Direction * 8, DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(576 + FrameIndex + (int)Direction * 10, DrawLocation, Color.White, true);
                            break;
                        case MirAction.被击动作:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(656 + FrameIndex + (int)Direction * 3, DrawLocation, Color.White, true);
                            break;
                        case MirAction.死亡动作:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(680 + FrameIndex + (int)Direction * 15, DrawLocation, Color.White, true);
                            break;
                        case MirAction.切换LIB:
                            Libraries.Monsters[(ushort)Monster.Mon432P].DrawBlend(407 + (FrameIndex * -1) + (int)Direction * 8, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.BlackTortoise: //433
                ...
                case Monster.Mon612N:
                    ...
                    {
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon612N].DrawBlend((360 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon614B:
                    ...
                    {
                        case MirAction.站立动作:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((480 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.行走动作:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((528 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((576 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((986 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((624 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((1034 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击3:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((672 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((752 + FrameIndex + (int)Direction * 7), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((808 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.被击动作:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((856 + FrameIndex + (int)Direction * 3), DrawLocation, Color.White, true);
                            break;
                        case MirAction.死亡动作:
                            Libraries.Monsters[(ushort)Monster.Mon614B].DrawBlend((880 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon615B:
                    ...
                    {
                        case MirAction.站立动作:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((504 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.行走动作:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((552 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((600 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((1014 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((648 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((696 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击3:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((760 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((840 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.被击动作:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((904 + FrameIndex + (int)Direction * 3), DrawLocation, Color.White, true);
                            break;
                        case MirAction.死亡动作:
                            Libraries.Monsters[(ushort)Monster.Mon615B].DrawBlend((928 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon620B:
                    ...
                    {
                        case MirAction.近距攻击3:
                            Libraries.Monsters[(ushort)Monster.Mon620B].DrawBlend((930 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击5:
                            Libraries.Monsters[(ushort)Monster.Mon620B].DrawBlend((1160 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon620B].DrawBlend((1280 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.石化状态:
                        case MirAction.坐下动作:
                ...
                case Monster.Mon622N:
                    ...
                    {
                        case MirAction.近距攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon622N].DrawBlend((790 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon622N].DrawBlend((880 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击3:
                ...
                case Monster.Mon625S:
                    ...
                    {
                        case MirAction.近距攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon625S].DrawBlend((535 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击3:
                            Libraries.Monsters[(ushort)Monster.Mon625S].DrawBlend((615 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon626N:
                    switch (CurrentAction)
                    {
                        case MirAction.刺客冲击:
                            Libraries.Monsters[(ushort)Monster.Mon626N].DrawBlend((494 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon627P:
                    ...
                    {
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon627P].DrawBlend((395 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon627P].DrawBlend((466 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                ...
                case Monster.Mon635S:
                    ...
                    {
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon635S].DrawBlend((504 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon635S].DrawBlend((575 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon635S].DrawBlend((688 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon637B:
                    ...
                    {
                        case MirAction.站立动作:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((635 + FrameIndex + (int)Direction * 6), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((683 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((1075 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((747 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((1145 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((827 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((1241 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.远程攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((891 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((1333 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                        case MirAction.被击动作:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((971 + FrameIndex + (int)Direction * 3), DrawLocation, Color.White, true);
                            break;
                        case MirAction.死亡动作:
                            Libraries.Monsters[(ushort)Monster.Mon637B].DrawBlend((995 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon638T:
                    switch (CurrentAction)
                    {
                        case MirAction.死亡动作:
                ...
                case Monster.Mon641S:
                    ...
                    break;
                case Monster.Mon643T:
                    switch (CurrentAction)
                    {
                        case MirAction.死亡动作:
                            Libraries.Monsters[(ushort)Monster.Mon643T].DrawBlend((152 + FrameIndex + (int)Direction * 10), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon645T:
                    switch (CurrentAction)
                    {
                        case MirAction.死亡动作:
                            Libraries.Monsters[(ushort)Monster.Mon645T].DrawBlend((136 + FrameIndex + (int)Direction * 11), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon647N:
                    switch (CurrentAction)
                    {
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon647N].DrawBlend((320 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                        case MirAction.近距攻击2:
                            Libraries.Monsters[(ushort)Monster.Mon647N].DrawBlend((384 + FrameIndex + (int)Direction * 9), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon648N:
                    switch (CurrentAction)
                    {
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon648N].DrawBlend((296 + FrameIndex + (int)Direction * 8), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon649B:
                    ...
                    {
                        case MirAction.近距攻击1:
                            Libraries.Monsters[(ushort)Monster.Mon649B].DrawBlend((440 + FrameIndex + (int)Direction * 7), DrawLocation, Color.White, true);
                            break;
                    }
                    break;
                case Monster.Mon650N:
                    switch (CurrentAction)
                    {
                        case MirAction.近距攻击1:
                ...
                case Monster.Mon354B:
                    ...
                    {
                        case MirAction.近距攻击1:
                            if (FrameIndex >= 2) Libraries.Monsters[(ushort)Monster.Mon354B].DrawBlend((504 + FrameIndex + (int)Direction * 5) - 2, DrawLocation, Color.White, true);
                            break;
                    }
                    break;
