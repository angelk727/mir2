namespace Server.Database
{
    partial class RecipeInfoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            RecipeGroupBox.Text = "合成配方 (必选)";
            // 
            // ItemComboBox
            // 
            ItemComboBox.FormattingEnabled = true;
            ItemComboBox.Location = new Point(52, 18);
            ...
            // GoldTextBox
            // 
            GoldTextBox.Location = new Point(79, 111);
            ...
            // ChanceTextBox
            // 
            ChanceTextBox.Location = new Point(79, 78);
            ...
            IngredientsGroupBox.Text = "所需材料 (必选)";
            // 
            ...
            label8.Location = new Point(199, 22);
            label8.Name = "label8";
            ...
            RecipeCountLabel.Location = new Point(5, 167);
            RecipeCountLabel.Name = "RecipeCountLabel";
            RecipeCountLabel.Size = new Size(44, 17);
            RecipeCountLabel.TabIndex = 13;
            RecipeCountLabel.Text = "合计：";
            // 
            // DeleteButton
            // 
